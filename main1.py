...
class HealthMonitorApp:
    ...
    # def delete_specific_data(self, login, password):
    ...
    #
    #     self.delete_specific_data("example_login", "example_password")

    def clear_file(self):
        with open("account.txt", "w", encoding="utf-8") as file:
            pass  # Открываем файл в режиме записи, что автоматически очищает его
